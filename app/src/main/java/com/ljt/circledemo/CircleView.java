...
public class CircleView extends View{
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        progressColor = typedArray.getColor(R.styleable.CircleView_progress_color, Color.GREEN);
        bgColor = typedArray.getColor(R.styleable.CircleView_bg_color, Color.GRAY);
        startAngle = typedArray.getFloat(R.styleable.CircleView_start_angle, 0);
        sweepAngle = typedArray.getFloat(R.styleable.CircleView_sweep_angle, 360);
        barWidth = typedArray.getDimension(R.styleable.CircleView_bar_width, DpOrPxUtils.dip2px(context, 10));
        typedArray.recycle();
